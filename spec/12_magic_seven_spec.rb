...
describe MagicSeven do
  ...
  describe '#divide_by_two' do
    context 'when the previous step clears' do
      it 'returns 6' do
        previous_step = 12
  ...
  describe '#subtract_random_number' do
    subject(:game) {described_class.new(24)}
    context 'checks if works with random number' do
      it 'returns 21' do
        result = game.subtract_random_number(3)
  ...
  describe '#play' do
    context 'when the random number is positive' do
    ...
    context 'when the random number is a negative' do
      # remove the 'x' before running this test
      subject(:game) {described_class.new(-66)}
      it 'will return 7' do
        result = game.play
        expect(result).to eq(7)
      end
    ...
    context 'when the random number is a float' do
      # remove the 'x' before running this test
      subject(:game) {described_class.new(12.4)}
      it 'will return 7' do
        result = game.play.round
        expect(result).to eq(7)
      end
    end
  end
